...
public class SideMenu extends HorizontalLayout
{
	...
	{
		userItem.addItem(text, icon, selectedItem -> handler.click());
	}

	public void setUserNavigation(String nagivateTo)
	{
		userItem.setCommand(selectedItem -> getUI().getNavigator().navigateTo(nagivateTo));
	}
