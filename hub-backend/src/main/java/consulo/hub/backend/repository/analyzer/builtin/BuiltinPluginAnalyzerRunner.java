 ...
 * @since 06/05/2023
 */
public class BuiltinPluginAnalyzerRunner implements PluginAnalyzerRunner {
    private final PluginAnalyzerEnv myEnv;
    private final ObjectMapper myObjectMapper;

    public BuiltinPluginAnalyzerRunner(PluginAnalyzerEnv env, ObjectMapper objectMapper) {
        myEnv = env;
