...
/**
 * https://github.com/retomerz/vaadin-flow-recaptcha/blob/master/src/main/java/ch/retomerz/recaptcha/ReCaptcha.java
 */
@Tag("my-recaptcha")
public class ReCaptcha extends Component implements Captcha {
    ...
    private boolean checkResponse(String response) throws IOException {
        ...
        Object jsonValue = map.get("success");
        return jsonValue instanceof Boolean v && v;
    }
