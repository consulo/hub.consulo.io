...
//import consulo.hub.backend.auth.oauth2.util.SerializationUtils;
...
//		JpaOAuthAccessToken jpa = myRepository.findById(extractTokenKey(token)).orElse(null);
//		if(jpa != null)
//		{
//			try
//			{
...
//		JpaOAuthAccessToken jpa = myRepository.findById(extractTokenKey(tokenValue)).orElse(null);
//
...
//	{
//		myRepository.deleteById(extractTokenKey(tokenValue));
//	}
//
//	@Override
